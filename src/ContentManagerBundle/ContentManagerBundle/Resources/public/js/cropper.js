$(function(){
  ...
  $('<img id="imgToCrop" class="cropbox" src="#" />').insertAfter('#ContentManagerBundle_tutorialbundle_tutorialtype_path');
  $('<div class="clear"></div>').insertAfter('#imgToCrop');

  $('#ContentManagerBundle_tutorialbundle_tutorialtype_path').attr('onChange','readURL(this)');
