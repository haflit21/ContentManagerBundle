...
use ContentManagerBundle\ContentManagerBundle\Type\CMContentType;
...
class ContentController extends Controller
{
     ...
     * @Template("ContentManagerBundle:CMContentManager:contents-list.html.twig")
     */
    public function listAction()
    {
    	$defaultLanguage = $this->getLanguageDefault();
        var_dump($defaultLanguage);die();
     ...
     * @Template("ContentManagerBundle:CMContentManager:contents-item.html.twig")
     */
    public function newItemAction(Request $request, $lang)
    {
        ...
        if ($request->isMethod('POST')) {
	        ...
	        if ($form->isValid()) {
                ...
                $contenttype = $CM->request->get('contenttype');
